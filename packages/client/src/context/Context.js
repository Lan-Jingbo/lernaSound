...
export const ContextProvider = ({ children }) => {
  ...
  const { animate, euclideanDistance, eyePoint, namedKeypoints } =
  ...
  const { recording, toggleRecording, save, timeElapsed } = useRecording(
    euclideanDistance,
    signalProcessingData.newFilteredItem,
